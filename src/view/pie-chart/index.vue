<template>
    <section class="pie-chart">
        ...
        <section ref="rightView" class="right">
            <base-pie ref="pie" :id="'pieChart'" :title="data.title" :subtext="data.subtext" :width="rightWidth"
                :height="rightHeight" :legend="data.legend" :isAnnular="data.isAnnular"></base-pie>
        </section>
    </section>
</template>
...
import basePie from '@/components/echarts/base-pie/index.vue'
// 配置项内容
