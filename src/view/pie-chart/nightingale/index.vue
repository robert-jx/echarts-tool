    ...
    <section class="pie-chart">
        <section class="left">
            ...
            <section class="content">
                ...
                <section class="left-item">
                    <section class="item-title">是否为环形</section>
                    <section class="item-content">
                        <el-switch v-model="data.isAnnular" />
                    </section>
                </section>
        ...
        <section ref="rightView" class="right">
            <nightingale-chart ref="nightingale" :id="'nightingale'" :title="data.title" :subtext="data.subtext"
                :width="rightWidth" :height="rightHeight" :legend="data.legend"
                :isAnnular="data.isAnnular"></nightingale-chart>
        </section>
    </section>
</template>
...
import nightingaleChart from '@/components/echarts/nightingale/index.vue'
// 配置项内容
...
const setEcharts = () => {
    nextTick(() => {
        (nightingale as any).value.reset()
