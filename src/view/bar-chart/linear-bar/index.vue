<template>
    <section class="bar-chart">
        ...
        <section ref="rightView" class="right">
            <linear-bar ref="bar" :id="'barChart'" :title="data.title" :width="rightWidth" :height="rightHeight"
                ...
                :markPoint="data.markPoint"></linear-bar>
        </section>
    </section>
</template>
...
import linearBar from '@/components/echarts/linear-bar/index.vue'
// 配置项内容
